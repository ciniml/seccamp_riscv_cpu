...
set ETHERNET_DIR  [lindex $argv 7]
...
add_file -type verilog [file normalize ${SRC_DIR}/../dvi_out.sv]
add_file -type verilog [file normalize ${SRC_DIR}/../test_pattern_generator.sv]
